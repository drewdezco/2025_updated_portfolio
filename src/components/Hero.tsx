    ...
    <section id="hero" className="min-h-screen flex items-center hero-gradient relative overflow-hidden">
      ...
      <div className="container-max section-padding py-20 relative z-10">
        <div className="max-w-4xl">
          ...
          {/* Open to work / location — third to fade in */}
          <div
          ...
          >
            <p className="text-gray-400 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
              Open to{' '}
              <span className="text-gray-300">hybrid</span> and{' '}
              <span className="text-gray-300">on-site</span> roles in{' '}
              <span className="text-gray-300 font-medium">Virginia</span>
              , and all <span className="text-gray-300">remote</span> opportunities.
            </p>
          </div>
